# Template SK Drop Out

## File yang Tersedia

✅ **SK_Drop_Out.aspx** - Halaman web ASP.NET untuk menampilkan SK
✅ **SK_Drop_Out.aspx.cs** - Code-behind/logic untuk halaman ASP.NET
✅ **SK_Drop_Out.aspx.designer.cs** - Designer code ASP.NET (auto-generated)
✅ **Report_SK_Drop_Out_2.rpt** - Template Crystal Reports (3.8 MB)
...
2. Pastikan file Report_SK_Drop_Out_2.rpt sudah ada di folder yang sama
3. Konfigurasi connection string dan app settings sesuai dengan environment
4. Akses halaman dengan URL: `https://your-app.com/Reports/SK_Drop_Out.aspx?token={encrypted_id}`

## File yang Masih Perlu Ditambahkan

Untuk melengkapi template, tambahkan file berikut ke folder ini:
- **Report_SK_Drop_Out_2.rpt** - File Crystal Reports template
- **Report_SK_Drop_Out_2.cs** - Wrapper class untuk load .rpt file
